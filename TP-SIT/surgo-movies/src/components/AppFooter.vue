...
<template>
    <footer class="py-4" style="background-color: #C7B299;">
        <div class="container pb-5 mb-5">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                
                <div class="text-center text-md-left">
                    <div class="ml-4 p-3">
                        <img src="/icon-brand.png" alt="Surgo Movies" style="height: 40px;">
                    </div>

                    <div>
                        <a href="#" class="mx-2 text-dark">
                            <svg viewBox="0 0 24 24" width="24" height="24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        </a>
                        <a href="#" class="mx-2 text-dark">
                ...
                <div>
                    <h6 class="mb-3 font-weight-bold">Contacts</h6>
                    <p class="mb-1">Email: info@surgomovies.com</p>
                    <p class="mb-1">Tel: +39 012 345 6789</p>
                    <p class="mb-0">Address: Via Roma 123, Milano</p>
                </div>
            </div>
        </div>
    </footer>
